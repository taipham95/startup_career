  ...
  return (
    <div className="relative mb-3 grow font-light text-sm">
      <input
        type={type}
        required={required}
        className= {`peer w-full min-h-[auto] rounded-lg border bg-white py-4 px-3 leading-[1.6] placeholder-gray-500 focus:placeholder-transparent outline-none transition-all duration-200 ease-linear motion-reduce:transition-none focus:outline-none focus:shadow-none focus:ring-transparent ${required ? 'dark:focus:border-rose-500 focus:border-rose-500' : 'dark:focus:border-sky-300 focus:border-sky-300'}`}
        id={idInput}        
