            ...
            <div className="flex text-xs sm:text-sm md:text-base flex-col sm:flex-row justify-center gap-4 lg:gap-8">
              <div className="relative w-2/3 mx-auto sm:mx-0 sm:w-full lg:max-w-[60%]">
                ...
                <input
                  ...
                  type="search"
                  id="default-search"
                  className=" block w-full py-[0.75rem] sm:py-4 px-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  placeholder="Search..."
                  required
                />
              </div>
