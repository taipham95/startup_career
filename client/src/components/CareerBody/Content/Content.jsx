                    ...
                    <div className='w-2/3 m-auto'>
                        ...
                        <div className=' p-2 '>
                            ...
                            {jobsData
                                ...
                                .filter((item) => (select1 === "" || item.location.toLowerCase().includes(select1.toLowerCase()) || item.tags[0].toLowerCase().includes(select1.toLowerCase())) && (select2 === "" || item.tags[1].toLowerCase().includes(select2.toLowerCase())))
                        ...
                        {visibleCount < jobsData.length && (
                            <div class="flex items-center justify-center svelte-1jp7mce"><button onClick={showMore} class="text-[#4C98FF] cursor-pointer text-center font-semibold mt-[28px] text-base svelte-1jp7mce">Show more</button></div>
                        )}
                    </div>
                ) : (
                    <Loading />
