...
const CareerFooter = () => {
  return (
    <footer className="w-full mx-auto bg-slate-800">
        <div className="grid grid-cols-4 gap-x-10 max-w-7xl mx-auto my-auto pt-20 pb-10">
            ...
            <div className="text-white ml-20">
                ...
                <ul className="text-sm ">
                    ...
                    <li className="mb-4">
                        <a href="https://axieinfinity.com/?download=true" className="hover:underline hover:text-blue-500">Hub</a>
                    </li>
                    <li className="mb-4">
                        <a href="https://wallet.roninchain.com/" className="hover:underline hover:text-blue-500">Ronin Wallet</a>
                    </li>
                    <li className="mb-4">
                        <a href="https://explorer.roninchain.com/" className="hover:underline hover:text-blue-500">Explorer</a>
                    </li>
                    <li className="mb-4">
                        <a href="https://bridge.roninchain.com/" className="hover:underline hover:text-blue-500">Bridge</a>
                    </li>
                    <li className="mb-4">
                        <a href="https://stake.axieinfinity.com/" className="hover:underline hover:text-blue-500">Staking</a>
                    </li>
                </ul>
            </div>
            <div className="text-white ml-20">
                ...
                <ul className="text-sm ">
                    ...
                    <li className="mb-4">
                        <a href="https://axie.substack.com/" className="hover:underline  hover:text-blue-500">Blog</a>
                    </li>
                    <li className="mb-4">
                        <a href="/careers" className="hover:underline  hover:text-blue-500">Careers</a>
                    </li>
                    <li className="mb-4">
                        <a href="https://cdn.axieinfinity.com/skymavis/terms-of-use.pdf" className="hover:underline  hover:text-blue-500">Terms of use</a>
                    </li>
                </ul>
            </div>
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0 text-white">
                <a href="https://www.facebook.com/SkyMavisHQ" className=" hover:text-blue-500">
                ...
                <a href="https://www.linkedin.com/company/skymavis/" className=" hover:text-blue-500">
                ...
                <a href="https://twitter.com/SkyMavisHQ" className="hover:text-blue-500">
