    ...
    <form className="pt-6 w-full" onSubmit={handleSubmit()}>
      ...
      <div className="w-full flex flex-col gap-6">
        ...
        <div className="w-full pt-6">
          ...
          >
            Education<span className="text-gray-400 font-semibold">&nbsp;(Option)</span>
          </p>
          <button type="button" class="text-white bg-sky-500 hover:bg-sky-600 focus:bg-gray-400 focus:outline-none focus:ring-transparent font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-sky-300 dark:hover:bg-sky-500 transition duration-150">+ Add</button>
          </div>
          <div className="flex flex-wrap justify-between items-center pb-4">
          <p class="uppercase text-[0.65rem] font-extrabold text-gray-900 dark:text-white"
          >
            Experiences<span className="text-gray-400 font-semibold">&nbsp;(Option)</span>
          </p>
          <button type="button" class="text-white bg-sky-500 hover:bg-sky-600 focus:bg-gray-400 focus:outline-none focus:ring-transparent font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-sky-300 dark:hover:bg-sky-500 transition duration-150">+ Add</button>
          </div>
          <FileInput />
        ...
        <div className="w-full pt-6 relative">
          ...
          >
            Cover letter<span className="text-gray-400 font-semibold">&nbsp;(Option)</span>
          </label>
          <textarea
            id="coverLetter"
            rows="6"
