...
const JobCreatorPage = () => {
  ...
  const onRequirementChange = (value) => {
    setJobRequire(value);
  };
  ...
  return (
    <div id="#editor-container" className="h-screen w-full mx-auto">
      <div className="job-form w-full h-full mx-auto py-8">
        <form
          className=" w-full sm:w-[80%] flex flex-col justify-between h-full bg-white rounded-xl opacity-85 px-10 py-4 mx-auto"
        ...
        >
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <QuillEditor
              ...
              onEditorChange={onDesChange}
            />
          </div>
          <div className="w-full flex flex-col gap-2">
            <h4 className="text-sm font-medium">Job Requirement</h4>
            <QuillEditor
              placeholder={"Write requirement..."}
              onEditorChange={onRequirementChange}
            />
          </div>
